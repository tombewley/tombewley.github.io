...
#Content/Course on "deep [Reinforcement Learning](../../../Roam/Reinforcement%20Learning.md), decision making and control" by [Sergey Levine](../../../Roam/Sergey%20Levine.md) and others at [UC Berkeley](../../../Roam/UC%20Berkeley.md).
...
BC suffers from a stability problem called [[Covariate Shift]] ($p_{data}(o_t)\neq p_{\pi_\theta}(o_t)$). It is theoretically proven that [DAgger](../../../Roam/A%20Reduction%20of%20Imitation%20Learning%20and%20Structured%20Prediction%20to%20No-Regret%20Online%20Learning.md) progressively mitigates this problem over time. 
